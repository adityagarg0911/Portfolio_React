...
const Achievements = () => {
  ...
  const cardData = [
    { color: "linear-gradient(to right, #799F0C, #ACBB78)", text: "Rank 993 in Google Code Jam Farewell Round A 2023" },
    { color: "linear-gradient(to right, #314755, #26a0da)", text: "AIR 7212 among 1.2 Million Candidates appearing for JEE Mains" },
    { color: "linear-gradient(to right, #314755, #26a0da)", text: "AIR 5681 among 150 Thousand+ Candidates appearing for JEE Advanced" },
    ...
    { color: "linear-gradient(to right, #f12711, #f5af19)", text: "Knight on Leetcode" },
  ];
