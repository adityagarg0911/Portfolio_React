...
const KnowMore = () => {
  return (
    ...
    flex flex-col gap-[30px]'>
        ...
        sm:text-justify">
           I am <span className='text-[#111]'>Aditya Garg</span>, a <span className='text-[#111]'>Computer Engineering student at 
           Delhi Technological University</span>, deeply involved in exploring algorithms and problem-solving. Recently, I completed an 
           internship at <span className='text-[#111]'>Microsoft as SWE Intern</span>, where I tackled real-world challenges firsthand. 
            ...
            gap-[15px] sm:gap-[50px] xl:gap-[30px]'>
              <div className='p:[20px] lg:p-[40px]'> 
                ...
                <div className='w-full flex justify-center'>
                  <Link to="https://drive.google.com/file/d/1mtzGLNczMUECN2XVvyG1BJvbZQOTgQG-/view" target="_blank">
                    <button className="
                    hover:bg-[#bbe6ff]
                    bg-[#d6f2ff]
                    flex justify-center 
