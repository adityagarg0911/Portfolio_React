  ...
  return (
    ...
    '>
        ...
        <div className='flex flex-col items-center justify-center'>
            <h1 className='text-[2.5rem] sm:text-[3.2rem] md:text-[2.5rem] lg:text-[3.2rem]'>SWE</h1>
            <h1 className='text-[2.5rem] sm:text-[3.2rem] md:text-[2.5rem] lg:text-[3.2rem]'>INTERN'24</h1>
            <p className='text-[1.8rem] sm:text-[2.5rem] md:text-[1.8rem] lg:text-[2.5rem]'>Company: <span className='text-[#111]'>Microsoft</span></p>
