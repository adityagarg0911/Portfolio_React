...
const Education = () => {
  ...
  const cardData={
    "linear-gradient(to right, #799F0C, #ACBB78)" : {name: "CSE @ DTU", year: "2025", place: "Delhi, India", grade:"9.23 CGPA"},
    "linear-gradient(to right, #314755, #26a0da)" : {name: "SPS", year: "2021", place: "Delhi, India", grade:"84.0%"},
    "linear-gradient(to right, #cc2b5e, #753a88)" : {name: "Model School", year: "2019", place: "Rohtak, India", grade:"93.8%"}
  }
